...
| Active Stand: 2026-08-22 | *Maschinenlesbarer Name*:MII_PR_Onko_Studienteilnahme |
...
> **Written during migration - review before release.** Die Instanzen hinter den beiden Beispielen sind `mii-exa-onko-studienteilnahme` (Beispiel 1) und `mii-exa-onko-studienteilnahme-prob` (Beispiel 2); die von Beispiel 2 referenzierte ResearchStudy-Ressource ist `mii-exa-onko-studie-prob`.
