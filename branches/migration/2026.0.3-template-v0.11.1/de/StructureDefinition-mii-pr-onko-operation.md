...
| Active Stand: 2026-08-22 | *Maschinenlesbarer Name*:MII_PR_Onko_Operation |
...
* Achtung: Innerhalb des KDS-Moduls Onkologie wird die übergeorndete MII-Prozedur auch für die Abbildung der Strahlen- und Systemischen/abwartenden Therapie genutzt. Für die Besondheiten bei Kategorien und Code siehe die Profile Strahlentherapie (`mii-pr-onko-strahlentherapie`) und Systemische Therapie (`mii-pr-onko-systemische-therapie`).
...
Weitere Informationen: siehe die Extension `mii-ex-onko-operation-intention`.
...
Weitere Informationen: siehe die Extension `mii-ex-onko-operation-urgency`.
