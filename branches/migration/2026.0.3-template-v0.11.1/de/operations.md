# Operationen - MII IG Kerndatensatz-Modul Onkologie v2026.0.3
...
Diese Seite listet die FHIR-Operationen, die das Modul **Onkologie** definiert (Namenskonvention `MII_OD_<Modul>_<Name>`), sofern definiert.
