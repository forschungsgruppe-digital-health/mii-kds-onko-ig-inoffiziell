...
| Active Stand: 2026-08-22 | *Maschinenlesbarer Name*:MII_PR_Onko_Tumorkonferenz |
...
> **Written during migration - review before release.** Drei Beispiele in diesem Leitfaden veranschaulichen das Profil: `mii-exa-onko-tumorkonferenz-01` für eine traditionelle oBDS-Tumorkonferenz (obds slice), `mii-exa-onko-tumorkonferenz-pure-molecular` für ein molekulares Tumorboard (extended slice) und `mii-exa-onko-tumorkonferenz-mixed-approach` für den gemischten Ansatz mit beiden Slices.
