...
<!-- Deutsche Quellfassung, wortgleich übernommen aus
     Therapieempfehlung-Medikation-MedicationRequest.page.md (MII IG Modul Onkologie,
     Simplifier). Simplifier-/FQL-Direktiven (Seitentitel, Darstellung/XML/JSON/Link-Tabs,
     FQL-Abfragen für Profil-Metadaten und oBDS-Mapping) wurden entfernt - der IG-Publisher
     stellt diese Informationen auf der Artefaktseite selbst dar. Die beiden
     pagelink-Direktiven wurden durch ihre Ziele ersetzt.
     Englische Fassung: input/intro-notes/StructureDefinition-mii-pr-onko-therapieempfehlung-medikation-intro.md -->
