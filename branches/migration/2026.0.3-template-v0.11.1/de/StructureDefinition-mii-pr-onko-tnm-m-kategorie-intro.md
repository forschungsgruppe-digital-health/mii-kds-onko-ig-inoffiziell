...
<!-- Deutsche Fassung (Quellsprache) von
     input/intro-notes/StructureDefinition-mii-pr-onko-tnm-m-kategorie-intro.md;
     Wortlaut übernommen aus TNM-Kategorie-M-Observation.page.md
     (MII IG Modul Onkologie 2026.x). -->
Dieses Profil beschreibt die M-Kategorie der TNM-Klassifikation. Die M-Kategorie
kodiert für das Fehlen bzw. Vorhandensein von Fernmetastasen und wird
entitätsspezifisch kodiert.
