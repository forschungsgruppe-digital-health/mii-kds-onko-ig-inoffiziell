...
<!-- Deutsche Fassung (Quellsprache) von TechnischeImplementierung/FHIR-Profile/Allgemeiner-Leistungszustand/Allgemeiner-Leistungszustand-ECOG-Observation.page.md
     Englisches Pendant: input/intro-notes/StructureDefinition-mii-pr-onko-allgemeiner-leistungszustand-ecog-intro.md -->
...
<!-- Quelldefekt, unverändert übernommen: das "_profile"-Beispiel unten nennt die
     ...
     dieses Profils ist (.../mii-pr-onko-allgemeiner-leistungszustand-ecog). Bei der
     Migration nicht korrigiert - bitte prüfen. -->
...
- Der Suchparameter `value-concept` MUSS unterstützt werden: `GET [base]/Observation?value-concept=https://www.medizininformatik-initiative.de/fhir/ext/modul-onko/CodeSystem/mii-cs-onko-allgemeiner-leistungszustand-ecog|2`
