...
| Active Stand: 2026-08-22 | *Maschinenlesbarer Name*:MII_PR_Onko_Tod |
...
> **Written during migration - review before release.** Drei Instanzen in diesem Leitfaden veranschaulichen das Profil: `mii-exa-onko-tod-j`, `mii-exa-onko-tod-n` und `mii-exa-onko-tod-u` - je eine pro Code (J, N, U) von `mii-cs-onko-tod`, also pro Interpretation des Zusammenhanges zwischen Tumorerkrankung und Todesursache.
