...
| Active Stand: 2026-08-22 | *Maschinenlesbarer Name*:MII_PR_Onko_Verlauf |
...
> **Written during migration - review before release.** Suchparameter 2 oben trägt die Canonical von `mii-pr-onko-allgemeiner-leistungszustand`, nicht die dieses Profils. Der Wortlaut wurde unverändert aus der Quellseite übernommen; vor der Veröffentlichung ist er auf `https://www.medizininformatik-initiative.de/fhir/ext/modul-onko/StructureDefinition/mii-pr-onko-verlauf` zu korrigieren. Derselbe Copy-and-paste-Fehler betraf die gelöschten Mapping-Abfragen der Quellseite.

### Beispiele

> **Written during migration - review before release.** Die Instanz `mii-exa-onko-verlauf-tumor` in diesem Leitfaden veranschaulicht das Profil.
