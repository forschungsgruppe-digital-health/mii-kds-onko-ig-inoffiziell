...
| Active Stand: 2026-08-22 | *Maschinenlesbarer Name*:MII_PR_Onko_Nebenwirkung_Adverse_Event |
...
> **Written during migration - review before release.** Der letzte Absatz bricht in der Quellseite mitten im Satz ab ("… um was für eine Art von Nebenwirkung es sich handelt. In"). Der Wortlaut wurde unverändert übernommen; der Satz ist vor der Veröffentlichung zu vervollständigen.

> **Written during migration - review before release.** Die Quellseite führte jeden Suchparameter einzeln mit Beispielabfrage und Verweis auf die FHIR-Basisspezifikation auf. Hier verdichtet auf die Parameternamen, die die Quellseite als verpflichtend (MUSS) benennt: `_id`, `_profile`, `event`, `seriousness` und `suspectEntity.instance`.
