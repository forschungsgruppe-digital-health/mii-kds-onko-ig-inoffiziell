...
<!-- Deutsche Fassung (Quellsprache) von Verlaufshistologie-Observation.page.md (MII IG Modul Onkologie, Simplifier).
     Englisches Pendant: input/intro-notes/StructureDefinition-mii-pr-onko-histologie-icdo3-intro.md -->
