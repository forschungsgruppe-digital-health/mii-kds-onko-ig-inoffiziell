...
| Active Stand: 2026-08-22 | *Maschinenlesbarer Name*:MII_PR_Onko_Anzahl_Befallene_Lymphknoten |
...
> **Written during migration - review before release.** Dieses Profil bildet den Datenpunkt **Befallene Lymphknoten** ab. Die drei übrigen Datenpunkte sind als eigene Profile abgebildet: [Anzahl untersuchte Lymphknoten](StructureDefinition-mii-pr-onko-anzahl-untersuchte-lymphknoten.md), [Anzahl befallene Sentinel-Lymphknoten](StructureDefinition-mii-pr-onko-anzahl-befallene-sentinel-lymphknoten.md) und [Anzahl untersuchte Sentinel-Lymphknoten](StructureDefinition-mii-pr-onko-anzahl-untersuchte-sentinel-lymphknoten.md). Im Quell-Leitfaden waren alle vier wegen ihrer sehr ähnlichen inhaltlichen Profilierung auf einer gemeinsamen Seite dargestellt.
