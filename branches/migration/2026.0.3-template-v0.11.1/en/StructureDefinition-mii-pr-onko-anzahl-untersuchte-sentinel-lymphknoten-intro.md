...
<!-- Migrated from Lymphknotenuntersuchung-Observation.page.md (MII IG Modul Onkologie, Simplifier guide tree).
     ...
     German mirror (source language): input/translations/de/intro-notes/StructureDefinition-mii-pr-onko-anzahl-untersuchte-sentinel-lymphknoten-intro.md -->
...
> **Written during migration - review before release.** This profile covers the data point *Untersuchte Sentinel-Lymphknoten* (examined sentinel lymph nodes). The other three data points are separate profiles: [Anzahl befallene Lymphknoten](StructureDefinition-mii-pr-onko-anzahl-befallene-lymphknoten.html), [Anzahl untersuchte Lymphknoten](StructureDefinition-mii-pr-onko-anzahl-untersuchte-lymphknoten.html) and [Anzahl befallene Sentinel-Lymphknoten](StructureDefinition-mii-pr-onko-anzahl-befallene-sentinel-lymphknoten.html). In the source guide all four were profiled and mapped on one shared page because their content is very similar.
