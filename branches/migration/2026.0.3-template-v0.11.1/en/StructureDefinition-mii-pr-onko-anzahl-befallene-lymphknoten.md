...
| Active as of 2026-08-22 | *Computable Name*:MII_PR_Onko_Anzahl_Befallene_Lymphknoten |
...
> **Written during migration - review before release.** This profile covers the data point **Befallene Lymphknoten** (involved lymph nodes). The other three data points are separate profiles: [Anzahl untersuchte Lymphknoten](StructureDefinition-mii-pr-onko-anzahl-untersuchte-lymphknoten.md), [Anzahl befallene Sentinel-Lymphknoten](StructureDefinition-mii-pr-onko-anzahl-befallene-sentinel-lymphknoten.md) and [Anzahl untersuchte Sentinel-Lymphknoten](StructureDefinition-mii-pr-onko-anzahl-untersuchte-sentinel-lymphknoten.md). In the source guide all four were profiled and mapped on one shared page because their content is very similar.
