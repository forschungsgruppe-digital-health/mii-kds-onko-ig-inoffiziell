...
| Active as of 2026-08-22 | *Computable Name*:MII_PR_Onko_Allgemeiner_Leistungszustand_Karnofsky |
...
Recording the general performance status is prescribed in the oBDS. The actual report is coded and transmitted as ECOG, whereby the answer options allow a mapping from the Karnofsky score.

In the previous oBDS and in the FHIR profiles at hand, documenting the ECOG with the answer options 0-4 as well as the Karnofsky score with 10%, 20% etc. is permitted. The current Umsetzungsleitfaden does, however, contain a note that in future only the ECOG shall be reported. https://plattform65c.atlassian.net/wiki/spaces/UMK/pages/15532323/Allgemeiner+Leistungszustand+Typ
