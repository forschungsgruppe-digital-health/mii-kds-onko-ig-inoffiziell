...
| Active as of 2026-08-22 | *Computable Name*:MII_PR_Onko_TNM_m_Symbol |
...
The explicit use of `m` codes for several tumours where the exact number is unknown. Instead of `m`, a specific number can also be given.

The m symbol is to be distinguished from the M category for the assessment of distant metastases.
