...
| Active as of 2026-08-22 | *Computable Name*:MII_PR_Onko_Residualstatus |
...
Depending on the procedures carried out, the oBDS dataset provides for either a local or a global determination of the residual status. The OPS catalogue of the procedures for which a local residual status is expected is provided by the Plattform §65c.
