...
<!-- Migrated from Lymphknotenuntersuchung-Observation.page.md (MII IG Modul Onkologie, Simplifier guide tree).
     ...
     German mirror (source language): input/translations/de/intro-notes/StructureDefinition-mii-pr-onko-anzahl-befallene-sentinel-lymphknoten-intro.md -->
