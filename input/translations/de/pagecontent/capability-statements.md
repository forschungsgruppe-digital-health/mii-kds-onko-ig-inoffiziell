...
<!-- source: CapabilityStatement.page.md (Simplifier-Guide,
     TechnischeImplementierung/CapabilityStatement.page.md). Die Quellseite
     rendert das Artefakt über eine Simplifier-render-Direktive auf dem
     Canonical; hier wird es aus der in diesem Guide erzeugten Ressource
     CapabilityStatement-mii-cps-onko-capabilitystatement gerendert. -->
### CapabilityStatement

Um eine dezentrale Datenauswertung mittel des Deutsche Forschungsdatenportal für
Gesundheit der Medizininformatik-Initiative zu ermöglichen MUSS die
