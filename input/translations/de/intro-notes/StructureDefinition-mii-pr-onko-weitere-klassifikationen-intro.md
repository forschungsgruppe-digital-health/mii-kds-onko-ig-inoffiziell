...
<!-- Deutsche Fassung (Quellsprache) von TechnischeImplementierung/FHIR-Profile/Weitere-Klassifikationen/Weitere-Klassifikationen-Observation.page.md
     Englisches Pendant: input/intro-notes/StructureDefinition-mii-pr-onko-weitere-klassifikationen-intro.md -->
...
- Der Suchparameter `_profile` MUSS unterstützt werden: `GET [base]/Observation?_profile=https://www.medizininformatik-initiative.de/fhir/ext/modul-onko/StructureDefinition/mii-pr-onko-weitere-klassifikationen`
...
- Der Suchparameter `method` SOLLTE unterstützt werden: `GET [base]/Observation?method=http://snomed.info/sct|254373007` — ermöglicht die Suche nach spezifischen Klassifikationsmethoden (z.B. FIGO, Ann Arbor Hodgkin vs. Non-Hodgkin)
