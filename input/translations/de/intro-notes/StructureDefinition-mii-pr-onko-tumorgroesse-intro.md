...
<!-- Deutsche Fassung (Quellsprache) von Tumorgroesse-Observation.page.md (MII IG Modul Onkologie, Simplifier).
     Englisches Pendant: input/intro-notes/StructureDefinition-mii-pr-onko-tumorgroesse-intro.md -->
