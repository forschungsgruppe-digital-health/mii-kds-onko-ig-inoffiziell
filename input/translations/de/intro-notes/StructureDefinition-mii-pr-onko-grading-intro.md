...
<!-- Deutsche Fassung (Quellsprache) von Grading-Observation.page.md (MII IG Modul Onkologie, Simplifier).
     Englisches Pendant: input/intro-notes/StructureDefinition-mii-pr-onko-grading-intro.md -->
