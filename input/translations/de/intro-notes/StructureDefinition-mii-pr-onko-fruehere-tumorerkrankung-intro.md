...
<!-- Deutsche Fassung (Quellsprache) von Fruehere-Tumorerkrankung-Condition.page.md (MII IG Modul Onkologie, Simplifier).
     Englisches Pendant: input/intro-notes/StructureDefinition-mii-pr-onko-fruehere-tumorerkrankung-intro.md -->
