...
<!-- Deutsche Quellfassung, wortgleich übernommen aus Genetische-Variante-Observation.page.md
     ...
     Reine Markup-Korrektur: In der Quelle stand bei den Suchparametern 3 ("status") und 10
     ("method") die schließende Code-Auszeichnung falsch und verschluckte den
     Anwendungshinweis-Satz. Die Auszeichnung wurde ans Ende der Beispielzeile gesetzt;
     der Wortlaut ist unverändert.
     Englische Fassung: input/intro-notes/StructureDefinition-mii-pr-onko-genetische-variante-intro.md -->
...
> **Written during migration - review before release.** Die Instanz
> `mii-exa-onko-genetische-variante-braf` in diesem Leitfaden veranschaulicht das Profil.
