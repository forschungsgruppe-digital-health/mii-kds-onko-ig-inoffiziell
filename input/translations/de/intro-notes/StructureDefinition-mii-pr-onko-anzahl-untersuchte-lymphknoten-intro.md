...
<!-- Deutsche Fassung (Quellsprache) von Lymphknotenuntersuchung-Observation.page.md (MII IG Modul Onkologie, Simplifier).
     ...
     Englisches Pendant: input/intro-notes/StructureDefinition-mii-pr-onko-anzahl-untersuchte-lymphknoten-intro.md -->
...
> **Written during migration - review before release.** Dieses Profil bildet den Datenpunkt *Untersuchte Lymphknoten* ab. Die drei übrigen Datenpunkte sind als eigene Profile abgebildet: [Anzahl befallene Lymphknoten](StructureDefinition-mii-pr-onko-anzahl-befallene-lymphknoten.html), [Anzahl befallene Sentinel-Lymphknoten](StructureDefinition-mii-pr-onko-anzahl-befallene-sentinel-lymphknoten.html) und [Anzahl untersuchte Sentinel-Lymphknoten](StructureDefinition-mii-pr-onko-anzahl-untersuchte-sentinel-lymphknoten.html). Im Quell-Leitfaden waren alle vier wegen ihrer sehr ähnlichen inhaltlichen Profilierung auf einer gemeinsamen Seite dargestellt.
