...
<!-- Deutsche Quellfassung, wortgleich übernommen aus Tumorkonferenz-CarePlan.page.md
     ...
     oBDS-Mapping) wurden entfernt - der IG-Publisher stellt diese Informationen auf
     der Artefaktseite selbst dar.
     Englische Fassung: input/intro-notes/StructureDefinition-mii-pr-onko-tumorkonferenz-intro.md -->
...
> **Written during migration - review before release.** Drei Beispiele in diesem Leitfaden
> veranschaulichen das Profil: `mii-exa-onko-tumorkonferenz-01` für eine traditionelle
> oBDS-Tumorkonferenz (obds slice), `mii-exa-onko-tumorkonferenz-pure-molecular` für ein molekulares
> Tumorboard (extended slice) und `mii-exa-onko-tumorkonferenz-mixed-approach` für den gemischten
> Ansatz mit beiden Slices.
