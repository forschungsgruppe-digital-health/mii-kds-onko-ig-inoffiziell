...
<!-- Deutsche Quellfassung, wortgleich übernommen aus
     Therapieempfehlung-Operation-ServiceRequest.page.md (MII IG Modul Onkologie, Simplifier).
     Simplifier-/FQL-Direktiven (Seitentitel, Darstellung/XML/JSON/Link-Tabs, FQL-Abfragen für
     Profil-Metadaten und oBDS-Mapping) wurden entfernt - der IG-Publisher stellt diese
     Informationen auf der Artefaktseite selbst dar. Die beiden pagelink-Direktiven wurden
     durch ihre Ziele ersetzt.
     Englische Fassung: input/intro-notes/StructureDefinition-mii-pr-onko-therapieempfehlung-operation-intro.md -->
...
Dieses Profil ist primär für die Verwendung mit dem **Tumorkonferenz Detailed Recommendations
CarePlan** konzipiert:
...
> **Written during migration - review before release.** Die Quellseite verwies auf ein Profil
> "Tumorkonferenz Detailed Recommendations CarePlan". Dieses Modul enthält dieses Profil nicht,
> daher steht der Verweis oben als reiner Text und nicht als Link. Vor der Veröffentlichung ist zu
> entscheiden, ob das Profil ergänzt oder der Satz auf
> [Tumorkonferenz](StructureDefinition-mii-pr-onko-tumorkonferenz.html) und dessen extended Slice
> umgeschrieben wird.
...
Die detaillierte Planung und Durchführung der Operation wird im separaten
[Operation (Procedure)](StructureDefinition-mii-pr-onko-operation.html) erfasst.
