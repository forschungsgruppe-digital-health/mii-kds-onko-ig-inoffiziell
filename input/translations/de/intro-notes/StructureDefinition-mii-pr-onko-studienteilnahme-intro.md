...
<!-- Deutsche Quellfassung, wortgleich übernommen aus Studienteilnahme-Observation.page.md
     ...
     Englische Fassung: input/intro-notes/StructureDefinition-mii-pr-onko-studienteilnahme-intro.md -->
...
> **Written during migration - review before release.** Die Instanzen hinter den beiden Beispielen
> sind `mii-exa-onko-studienteilnahme` (Beispiel 1) und `mii-exa-onko-studienteilnahme-prob`
> (Beispiel 2); die von Beispiel 2 referenzierte ResearchStudy-Ressource ist
> `mii-exa-onko-studie-prob`.
