...
<!-- Deutsche Fassung (Quellsprache) von Histologiebefund-DiagnosticReport.page.md (MII IG Modul Onkologie, Simplifier).
     Englisches Pendant: input/intro-notes/StructureDefinition-mii-pr-onko-befund-intro.md -->
