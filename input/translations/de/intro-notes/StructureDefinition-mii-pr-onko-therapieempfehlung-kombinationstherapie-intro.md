...
<!-- Deutsche Quellfassung, wortgleich übernommen aus
     Therapieempfehlung-Kombinationstherapie-RequestGroup.page.md (MII IG Modul Onkologie,
     Simplifier). Simplifier-/FQL-Direktiven (Seitentitel, Darstellung/XML/JSON/Link-Tabs,
     FQL-Abfragen für Profil-Metadaten, ValueSet-Auflistung und oBDS-Mapping) wurden
     entfernt - der IG-Publisher stellt diese Informationen auf der Artefaktseite selbst dar.
     Die beiden Beispiel-Direktiven der Quellseite verwiesen auf Instanzen, die dieses Modul
     (noch) nicht erzeugt; daher wird hier kein Beispiel benannt.
     Englische Fassung: input/intro-notes/StructureDefinition-mii-pr-onko-therapieempfehlung-kombinationstherapie-intro.md -->
