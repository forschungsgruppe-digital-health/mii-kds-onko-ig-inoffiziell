...
<!-- Deutsche Fassung (Quellsprache) von TechnischeImplementierung/FHIR-Profile/Allgemeiner-Leistungszustand/ASA-Klassifikation-Observation.page.md
     Englisches Pendant: input/intro-notes/StructureDefinition-mii-pr-onko-asa-klassifikation-intro.md -->
...
- Der Suchparameter `_profile` MUSS unterstützt werden: `GET [base]/Observation?_profile=https://www.medizininformatik-initiative.de/fhir/ext/modul-onko/StructureDefinition/mii-pr-onko-asa-klassifikation`
...
- Der Suchparameter `value-concept` MUSS unterstützt werden: `GET [base]/Observation?value-concept=https://www.medizininformatik-initiative.de/fhir/ext/modul-onko/CodeSystem/mii-cs-onko-asa-obds|2`
