...
<!-- Deutsche Fassung (Quellsprache) von Diagnose-Condition.page.md (MII IG Modul Onkologie, Simplifier).
     Englisches Pendant: input/intro-notes/StructureDefinition-mii-pr-onko-diagnose-primaertumor-intro.md -->
